...
public class PaginaEntrevistaTask  implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        /*
        actor.attemptsTo(SendKeys.of(Keys.ARROW_DOWN).into(TXT_INTERVIEWER));
        actor.attemptsTo(
                SendKeys.of(Keys.ENTER).into(TXT_INTERVIEWER)  // Simula presionar la tecla Enter en el campo
        );
        actor.attemptsTo(Enter.theValue(datosExcel.get(0).get("DATE")).into(TXT_DATE));
